...
{
    public class CodeAnalazyer : ICodeAnalazyer
    {
        ...
        {
            TestMethodInfo result = new TestMethodInfo(methodDeclaration.Identifier.ValueText, new DataStructure.TypeInfo(methodDeclaration.ReturnType.ToString()));

            foreach (ParameterSyntax parameter in methodDeclaration.ParameterList.Parameters)
            {
                result.Parameters.Add(new ParameterInfo(parameter.Identifier.ValueText, new DataStructure.TypeInfo(parameter.Type.ToString())));
            }
            return result;
        }
