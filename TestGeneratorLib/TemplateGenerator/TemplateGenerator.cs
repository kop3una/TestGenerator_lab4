...
namespace TestGeneratorLib.TemplatesGenerator
{
    public class TemplateGenerator : ITemplateGenerator
    {
        ...
        protected readonly ICodeAnalazyer codeAnalyzer;

        public IEnumerable<PathFile> Generate(string source)
        {
            if (source == null)
            {
            ...
            List<PathFile> resultList = new List<PathFile>();
            ...
            {
                resultList.Add(new PathFile(typeInfo.Name + "Test.cs", CompilationUnit()
                    .WithUsings(
        ...
        protected LocalDeclarationStatementSyntax CreateExpectedDeclaration(DataStructure.TypeInfo methodReturnType)
        {
            return CreateVariableInitializeExpression(new ParameterInfo(expectedVariableName, methodReturnType));
        }

        protected ExpressionStatementSyntax CreateAreEqualExpression(DataStructure.TypeInfo methodReturnType)
        {
            return ExpressionStatement(
                InvocationExpression(
                    MemberAccessExpression(
        ...
        public TemplateGenerator(ICodeAnalazyer codeAnalyzer)
        {
